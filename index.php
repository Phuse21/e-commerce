                ...
                <div class="row" style="margin-top: 20px; padding: 0">
                    <div class="col-md-4">
                        <a href="#" style="text-decoration: none">
                            <div class="card">
                                <img src="./images/Nike Zoom.png" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">Nike Zoom Vomero 5</h5>
                                    <p class="card-text">Men's Shoes</p>
                                    <h6 class="card-text">$169</h6>
                                    <div class="row">
                                        <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        <a href="#" style="text-decoration: none">
                            <div class="card">
                                <img src="./images/Air Jordan Wordmark.png" class="card-img-top" alt="...">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a class="nav-link favorite" href="#"><i class="fa fa-heart "
                                                    aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4">
                        <a href="#" style="text-decoration: none">
                            <div class="card">
                                <img src="./images/Air Jordan 3.png" class="card-img-top" alt="...">
                                <div class="card-body">
                    ...
                    <div>
                        <h4 style="margin-top: 20px;">Trending Products</h4>
                    </div>
